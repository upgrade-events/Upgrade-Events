    ...
    <div style={styles.container}>
      <nav style={styles.navbar}>
        <div style={styles.navContent}>
          ...
          <Link to="/" style={styles.navBackBtn}>← Voltar</Link>
        </div>
      </nav>
        ...
        <div style={styles.formContainer}>
          <div style={styles.formHeader}>
            <h1 style={styles.title}>
             <span style={styles.customLetterOrangeB}>{'\ue800'}</span>em-Vindo!
            </h1>
            <p style={styles.subtitle}>Log in para Continuar</p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={styles.form}>
            ...
            <p style={styles.signupText}>
              Não tens conta?{' '}
              <Link to="/register" style={styles.signupLink}>Cria uma</Link>
            </p>
          </form>
        </div>
      </div>
